  ...
  return (
    <div className="nd-overlay" onClick={onClose}>
      <div className="nd-panel glass" onClick={(e) => e.stopPropagation()}>
        ...
        {gen && gen.file && <button type="button" className="gen-dl" style={{ marginTop: 12 }} onClick={() => downloadOutput(gen.file, gen.url)}>⬇ 下载《{gen.title}》.{extOf(gen.fmt || gen.format)}</button>}
