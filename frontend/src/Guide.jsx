...
export const SOURCES = {
  ...
  realtime: {
    ...
    steps: [
      ...
      { t: '★第三步 · 点「抓取 / 更新密钥」(关键!不做这步会同步到空)', d: '微信聊天在电脑上是加密存的,助手要先拿到「解密钥匙」才能读。点「抓取 / 更新密钥」后会弹出一个微信,请你亲手做两件事:① 扫码登录;② 在搜索框随便搜一个词(比如你常聊的人的名字)—— 微信会一次性打开所有聊天库来搜索,钥匙就全抓到了,面板上「密钥」数字会几秒内涨到几十,不用你一个个点开。这把钥匙【抓这一次就长期有效】,以后手机上聊的会自动进来、不用每次抓;只有换了微信大版本、或加了全新的联系人/群时,再点一次补一下。注意:跳过这步会同步到空。' },
