      ...
      <div className="hstep glass">
        ...
        <div className="hstep-body">
          ...
          <ol className="hstep-ol">
            <li><b>点「抓取 / 更新密钥」</b> —— 会拉起微信,按提示<b>扫码登录一次</b>,然后<b>在搜索框随便搜一个词</b>(比如常聊的人名),微信会一次性打开所有聊天库、密钥几秒内全抓到(数字涨到几十),不用一个个点开。<b>密钥抓这一次就长期有效</b>,以后自动同步;只有换微信大版本、或加了全新联系人/群时再点一次补。<span className="hstep-note">Windows 上:助手需<b>右键 → 以管理员身份运行</b>,抓密钥要重新登录一次微信。</span></li>
