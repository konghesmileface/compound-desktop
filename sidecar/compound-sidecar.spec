...
try:
    ...
    pass
# 随包数据:嵌入/OCR/证书。★rapidocr_onnxruntime 必须收 datas(内置 onnx 检测/识别模型+config.yaml),
...
for pkg in ("sentence_transformers", "transformers", "tokenizers",
            "rapidocr_onnxruntime", "certifi", "jieba"):
    try:
...
for pkg in ("sentence_transformers", "transformers", "sklearn",
            ...
            "rapidocr_onnxruntime", "onnxruntime", "PIL", "certifi",
